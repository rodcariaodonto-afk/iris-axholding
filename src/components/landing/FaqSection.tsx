...
const FAQ = [
  ...
  },
  {
    ...
    a: "Starter (R$ 120/mês): 1 usuário e 1 sessão de WhatsApp. Pro (R$ 297/mês): até 5 usuários e 5 sessões. Business (R$ 997/mês): até 30 usuários e 30 sessões. Enterprise: sob consulta, com infraestrutura sob medida. Todos os planos incluem mensagens, respostas de IA e contatos ilimitados.",
  },
  {
