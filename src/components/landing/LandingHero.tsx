    ...
    <section id="top" className="relative pt-24 pb-16 sm:pt-28 sm:pb-20 bg-[#EFF6FF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          >
            <span className="h-1.5 w-1.5 rounded-full bg-[#e50789]" />
          ...
          >
            ...
            <span className="text-[#e50789]">Agente SDR de IA</span> trabalhando por você.
          </h1>

          <p className="mt-5 text-base sm:text-lg text-[#4B5563] max-w-xl" style={{ fontFamily: "Inter, sans-serif" }}>
            A FCE atende, qualifica e organiza seus leads automaticamente, enquanto sua equipe acompanha
          ...
          <div className="mt-7 flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="inline-flex h-12 items-center justify-center px-6 rounded-lg bg-[#e50789] text-white font-semibold hover:bg-[#c4066f] shadow-sm transition-colors"
              style={{ fontFamily: "Plus Jakarta Sans" }}
            >
            ...
            <a
              href="#como-funciona"
              className="inline-flex h-12 items-center justify-center px-6 rounded-lg border-2 border-[#e50789] text-[#0F172A] font-semibold hover:bg-[#e50789]/5 transition-colors"
              style={{ fontFamily: "Plus Jakarta Sans" }}
            >
              Como funciona
            </a>
...
function HeroMockup() {
  return (
    <div className="relative">
      <div className="absolute -inset-4 bg-gradient-to-tr from-[#e50789]/20 via-[#8f1b3f]/10 to-[#a3c928]/20 rounded-3xl blur-2xl" />
      <div className="relative rounded-2xl border border-slate-200 bg-white shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-200 bg-slate-50">
          ...
          <div className="ml-3 text-xs font-semibold text-slate-500">FCE · Conversas</div>
        </div>
        {/* chat preview */}
        <div className="p-5 space-y-3 bg-white min-h-[360px]">
          ...
          <div className="flex items-start gap-2 justify-end">
            <div className="bg-gradient-to-r from-[#e50789] to-[#8f1b3f] text-white rounded-2xl rounded-tr-none px-3 py-2 text-sm max-w-[75%]">
              Olá, João! Sou a FCE. Faço sim, posso entender melhor sua operação para te enviar
              uma proposta agora?
            </div>
            <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#e50789] to-[#8f1b3f] flex items-center justify-center">
          ...
          <div className="mt-4 rounded-xl border border-slate-200 bg-gradient-to-br from-[#EFF6FF] to-white p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Sparkles className="h-4 w-4 text-[#e50789]" />
            ...
            <div className="mt-3 flex items-center gap-2 text-xs text-[#4B5563]">
              <MessagesSquare className="h-3.5 w-3.5 text-[#8f1b3f]" />
