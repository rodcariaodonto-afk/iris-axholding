...
// Prompt inicial NEUTRO — nenhuma persona ou marca de cliente.
// Cada conta escreve o prompt do próprio agente em Configurações > Agente.
const DEFAULT_SYSTEM_PROMPT: string | null = null;
