...
import { isWithinBusinessHours, nextOpeningAt } from "../_shared/business-hours.ts";
...
function getDefaultSystemPrompt(): string {
  // Prompt neutro: NUNCA usar persona/marca de outro cliente.
  // Só é usado quando a conta ainda não configurou o prompt do próprio agente.
  return `<system_instruction>
<role>
Você é o assistente virtual de atendimento desta empresa no WhatsApp.
...
- Nunca invente informações, preços, prazos ou condições que não foram informados.
- Quando não souber algo, diga que vai verificar com a equipe.
- Nunca cite nomes de outras empresas, produtos ou marcas que não sejam desta empresa.
